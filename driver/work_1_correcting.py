...
def work_1_correcting(_driver):
    _url = "https://mooc.icve.com.cn/design/workExam/homework/preview.html?courseOpenId=x6nvaeouv5tfvankjlmxsq" \
           "&homeworkId=warvaeouy4zia4becmb7ew&pageType=mark "
    _driver.get(_url)  # 跳转到 <未审批> 页面
    time.sleep(3)
...
def check_answers(_driver, answers_num):
    """
    :param _driver: 浏览器对象
    :param answers_num: 题目的总数
    :return:
    """
